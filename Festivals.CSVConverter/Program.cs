...
using MoMi.CSVConverter.Converters;
using MoMi.CSVConverter.Entity;

namespace MoMi.CSVConverter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var path =
                @"E:\Visual Studio Projects\Festivals\Festivals.CSVConverter\Scrape_Sitemaps\Scrape festivals_de\festivalplaner_scrape.csv";
