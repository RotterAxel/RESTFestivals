...
namespace RESTFestivals.API
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Fantasy Festivals RESTFestivals.API");
            });
        ...
        public static IServiceCollection AddSwagger(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddSwaggerGen(options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    Version = "v1",
                    Description = "A RESTFull example of a Festivals RESTFestivals.API with the Repository pattern. More information under https://github.com/RotterAxel/RESTFestivals"
                });
            });
